    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sexe', models.CharField(choices=[('HOMME', 'HOMME'), ('FEMMME', 'FEMME'), ('AUCUN', 'AUCUN')], default='AUCUN', max_length=15)),
                ...
                ('description', models.CharField(default='Aucune description', max_length=200)),
                ('profession', models.CharField(default='Aucune rofession', max_length=200)),
